...
import cs301.amazebyjosephpalazzo.gui.MazeFileWriter;
...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        */
        //Uses the setColor methods in mazePanel
        case 0:
    ...
    public boolean equals(final Object other) {
        ...
        */
        //Changed it to return false if MazePanel RGB values are not equal 
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
