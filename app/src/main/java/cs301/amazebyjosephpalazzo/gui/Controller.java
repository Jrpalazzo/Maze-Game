...
import cs301.amazebyjosephpalazzo.gui.RobotDriver;
...
import cs301.amazebyjosephpalazzo.generation.Order;
import cs301.amazebyjosephpalazzo.generation.Order.Builder;
...
public class Controller {
    ...
    public void setMaze()
    {
		...
		driver.setDistance(this.getMazeConfiguration().getMazedists());
        driver.setDimensions(this.getMazeConfiguration().getWidth(), this.getMazeConfiguration().getHeight());
